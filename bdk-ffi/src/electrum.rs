...
use bdk_wallet::chain::bdk_core::spk_client::FullScanRequest as BdkFullScanRequest;
use bdk_wallet::chain::bdk_core::spk_client::FullScanResponse as BdkFullScanResponse;
use bdk_wallet::chain::bdk_core::spk_client::SyncRequest as BdkSyncRequest;
use bdk_wallet::chain::bdk_core::spk_client::SyncResponse as BdkSyncResponse;
...
use bdk_wallet::chain::bdk_core::bitcoin::hex::{Case, DisplayHex};
...
impl From<BdkServerFeaturesRes> for ServerFeaturesRes {
    fn from(value: BdkServerFeaturesRes) -> ServerFeaturesRes {
        ...
        let blockhash = hash_str.parse::<bdk_wallet::chain::bdk_core::bitcoin::BlockHash>().unwrap();
        ServerFeaturesRes {
