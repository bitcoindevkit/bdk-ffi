use bdk_kyoto::builder::LightClient as BDKLightClient;
...
impl LightClientBuilder {
    ...
    pub fn build(&self, wallet: &Wallet) -> Result<NodePair, LightClientBuilderError> {
        ...
        let mut builder = BDKLightClientBuilder::new(&wallet)
