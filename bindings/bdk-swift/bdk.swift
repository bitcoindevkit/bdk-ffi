...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_bdk_62af_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_bdk_62af_rustbuffer_free(self, $0) }
    }
}
...
public func generateExtendedKey(network: Network, mnemonicType: MnemonicType, password: String? ) throws -> ExtendedKeyInfo {
    ...
    bdk_62af_generate_extended_key(network.lower(), mnemonicType.lower(), FfiConverterOptionString.lower(password) , $0)
}
...
public func restoreExtendedKey(network: Network, mnemonic: String, password: String? ) throws -> ExtendedKeyInfo {
    ...
    bdk_62af_restore_extended_key(network.lower(), mnemonic.lower(), FfiConverterOptionString.lower(password) , $0)
}
    return try ExtendedKeyInfo.lift(_retval)
}
...
public class OfflineWallet: OfflineWalletProtocol {
    ...
    bdk_62af_OfflineWallet_new(descriptor.lower(), network.lower(), databaseConfig.lower() , $0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_62af_OfflineWallet_object_free(pointer, $0) }
    }
    ...
    bdk_62af_OfflineWallet_get_new_address(self.pointer,  $0
    )
}
    ...
    bdk_62af_OfflineWallet_get_balance(self.pointer,  $0
    )
}
    ...
    bdk_62af_OfflineWallet_sign(self.pointer, psbt.lower() , $0
    )
}
    }
    ...
    bdk_62af_OfflineWallet_get_transactions(self.pointer,  $0
    )
}
...
public class OnlineWallet: OnlineWalletProtocol {
    ...
    bdk_62af_OnlineWallet_new(descriptor.lower(), FfiConverterOptionString.lower(changeDescriptor), network.lower(), databaseConfig.lower(), blockchainConfig.lower() , $0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_62af_OnlineWallet_object_free(pointer, $0) }
    }
    ...
    bdk_62af_OnlineWallet_get_new_address(self.pointer,  $0
    )
}
        return try! String.lift(_retval)
    }
    ...
    bdk_62af_OnlineWallet_get_balance(self.pointer,  $0
    )
}
        return try UInt64.lift(_retval)
    }
    ...
    bdk_62af_OnlineWallet_sign(self.pointer, psbt.lower() , $0
    )
}
    }
    public func getTransactions() throws -> [Transaction] {
    ...
    bdk_62af_OnlineWallet_get_transactions(self.pointer,  $0
    )
}
        return try FfiConverterSequenceEnumTransaction.lift(_retval)
    }
    ...
    bdk_62af_OnlineWallet_get_network(self.pointer,  $0
    )
}
    ...
    bdk_62af_OnlineWallet_sync(self.pointer, ffiConverterCallbackInterfaceBdkProgress.lower(progressUpdate), FfiConverterOptionUInt32.lower(maxAddressParam) , $0
    )
}
    }
    ...
    bdk_62af_OnlineWallet_broadcast(self.pointer, psbt.lower() , $0
    )
}
        return try String.lift(_retval)
    }
...
public class PartiallySignedBitcoinTransaction: PartiallySignedBitcoinTransactionProtocol {
    ...
    bdk_62af_PartiallySignedBitcoinTransaction_new(wallet.lower(), recipient.lower(), amount.lower() , $0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_62af_PartiallySignedBitcoinTransaction_object_free(pointer, $0) }
    }
...
private let ffiConverterCallbackInterfaceBdkProgress: FfiConverterCallbackInterface<BdkProgress> = {
    try! rustCall { (err: UnsafeMutablePointer<RustCallStatus>) in
            ffi_bdk_62af_BdkProgress_init_callback(foreignCallbackCallbackInterfaceBdkProgress, err)
    }
